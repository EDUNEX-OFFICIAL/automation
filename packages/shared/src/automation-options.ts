...
export const ENABLED_AUTOMATION_OPERATIONS = ["enquiry_transfer"] as const;
...
export const SUB_SOURCES_BY_PARENT: Record<SubSourceParent, readonly string[]> = {
  Digital: ["HMIL Social Media", "Website", "Hyperlocal"],
...
export function isAutomationFormValid(
  ...
  if (!operation || sources.length === 0) return false;
